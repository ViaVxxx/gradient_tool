    ...
    <main class="max-w-7xl mx-auto px-6 py-6">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-3 space-y-4">
          ...
          <!-- 渐变类型卡片 -->
          <div class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40">
            ...
            <div class="grid grid-cols-1 gap-2">
              <button
                ...
                :class="[
                  'px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center space-x-2',
          ...
          <div class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40">
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <button @click="addColorStop"
                        ...
                        class="px-2 py-1 rounded-md text-xs bg-indigo-50 text-indigo-600 hover:bg-indigo-100 disabled:opacity-50 transition-colors">
                  + 添加
                </button>
              </div>
            </div>
            ...
            <div class="relative mb-4">
              <!-- 渐变条背景 -->
              <div 
                class="relative h-12 rounded-lg border-2 border-gray-300 overflow-hidden cursor-crosshair shadow-inner"
                :style="previewStyle"
                ...
                <div 
                  ...
                  <div class="relative">
                    <!-- 连接线 -->
                    <div class="w-0.5 h-12 bg-white/80 shadow-sm mx-auto"></div>
                    
                    <!-- 圆形手柄 -->
                    <div 
                      :class="[
                        'absolute -top-1 left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full border-2 shadow-lg transition-all duration-200',
            ...
            <!-- 当前选中色标的详细编辑 -->
            <div v-if="selectedColorStopIndex !== null" class="space-y-3 p-4 bg-gray-50/80 rounded-lg border border-gray-200">
              <div class="flex items-center justify-between">
              ...
              <div class="grid grid-cols-2 gap-3">
                <!-- 颜色选择器 -->
                <div>
                  <label class="block text-xs font-medium text-gray-600 mb-1">颜色选择</label>
                  <div class="relative">
                    <!-- 大色块显示 -->
                    <div 
                      class="w-full h-16 rounded-lg border-2 border-gray-200 cursor-pointer relative overflow-hidden shadow-inner hover:shadow-lg transition-shadow"
                      ...
                      <div class="absolute inset-0 flex items-center justify-center">
                        <div class="w-8 h-8 rounded-full border-2 border-white/60 flex items-center justify-center backdrop-blur-sm">
          ...
          <div v-if="gradientType === 'linear'"
               class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40">
            <h3 class="text-base font-semibold text-gray-800 mb-3 flex items-center">
              <svg class="w-4 h-4 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
              ...
              <div class="flex-1 space-y-3">
                <div>
                  <input
                    ...
                    max="360"
                    step="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-center text-xl font-bold text-indigo-600 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="lg:col-span-6">
          <div class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40 h-full">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-base font-semibold text-gray-800 flex items-center">
                <svg class="w-4 h-4 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- 渐变预览画布 -->
            <div class="relative rounded-lg overflow-hidden border-2 border-gray-200 shadow-inner" style="aspect-ratio: 4/3;">
              <!-- CSS 预览模式 -->
              <div
            ...
            <div class="mt-4 space-y-2">
              ...
              <div class="grid grid-cols-2 gap-2">
                <button @click="copyCSS"
                        class="px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium transition-colors flex items-center justify-center gap-2">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="savePreset"
                        :disabled="!generatedImage"
                        class="px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 disabled:bg-gray-50 disabled:text-gray-400 text-gray-700 text-sm font-medium transition-colors flex items-center justify-center gap-2">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40">
            ...
            <div class="space-y-3">
              <div
                ...
                <!-- 效果预览缩略图 -->
                <div class="h-12 relative overflow-hidden">
                  <div 
                ...
                <div class="p-3">
                  ...
                  <!-- 强度滑块 -->
                  <div v-if="effectsEnabled[effect.value]" class="space-y-1">
          ...
          <div class="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/60 p-4 shadow-lg shadow-gray-200/40">
            <div class="flex items-center justify-between mb-3">
              ...
              <select v-model="selectedPresetCategory" 
                      class="text-xs border border-gray-300 rounded-md px-2 py-1 bg-white focus:ring-1 focus:ring-indigo-500">
            ...
            <div class="grid grid-cols-2 gap-2 max-h-80 overflow-y-auto custom-scrollbar">
              <button
                v-for="preset in filteredPresets"
                :key="preset.name"
                @click="loadPreset(preset)"
                class="group relative h-16 rounded-lg overflow-hidden border-2 border-gray-200 hover:border-indigo-300 transition-all duration-200 shadow-sm hover:shadow-md">
                ...
                <!-- 选中指示器 -->
                <div class="absolute top-1 right-1 w-5 h-5 rounded-full bg-white/20 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
